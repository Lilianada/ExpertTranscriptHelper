          ...
          <div className="lg:py-30 relative px-6 pb-20 pt-24 lg:static lg:px-8">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                To make more enquiries about our services or to get custom made
                package, send us a message.
              </p>
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a
                      ...
                      href="https://t.me/ExpertTranscriptHelpers"
                    >
                      @ExpertTranscriptHelpers
                    </a>
                  </dd>
                </div>
                <div className="flex gap-x-4">
